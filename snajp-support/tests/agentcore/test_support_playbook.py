...
def test_conditional_steps_are_escalation_kb_article_and_retention():
    """kb-article villkorades 2026-08-26, cs:customer-escalation 2026-09-02:
    eskaleringsbedömningen körs bara när det finns något att bedöma
    (kunskapslucka, säkerhetssignal eller uttrycklig begäran om människa) —
    på lyckliga flödet var kedjans enda thinking-steg ren kostnad."""
