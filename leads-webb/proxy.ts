 ...
 *
 * Styrd av miljön: är `AGENTSAJT_LOSEN` inte satt (lokal utveckling) är
...
export async function proxy(request: NextRequest) {
  const losen = process.env.AGENTSAJT_LOSEN;
  ...
  const ssoHemlighet = process.env.AGENTSAJT_SSO_SECRET;
