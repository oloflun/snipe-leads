...
--
-- Den 2026-08-21 applicerades 039_prospect_origin.sql mot Supabase genom Management-API:t.
-- API:t registrerar sin EGEN 14-siffriga tidsstämpel som version, medan repots
-- fil heter 039_prospect_origin. Databasen bokförde alltså ändringen under ett nummer som
...
--
-- SQL:en bor i 039_prospect_origin.sql och körs därifrån. Att upprepa den här hade betytt att
-- varje ny databas kör samma ändring två gånger.
--
-- Radera inte filen för att den ser tom ut. Radera den den dag versionen
-- 20260821202122 är borta ur supabase_migrations.schema_migrations — inte innan.
