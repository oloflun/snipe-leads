...
export function FelOchEskaleringar({
  ...
  return (
    <section className="mt-14 border-t border-ink/15 pt-5">
      ...
      <div className="mt-6 grid gap-px overflow-hidden rounded-input border border-ink/15 bg-ink/15 sm:grid-cols-3">
        <Nyckeltal
      ...
      {toppfel.length === 0 ? (
        <p className="mt-6 text-[15px] text-mineral">
...
function Nyckeltal({
  ...
  return (
    <div className="bg-paper px-5 py-4">
      ...
      <p
        className={`mt-1.5 font-display text-[1.75rem] tabular-nums tracking-[-0.02em] ${
